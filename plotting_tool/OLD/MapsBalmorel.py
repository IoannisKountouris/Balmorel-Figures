...
line_width_constant = 4 #Constant related to thickness of lines: the higher the number, the narrower the lines will be
...
cat = 'cluster' # 'linear' = Capacities are scaled linearly, 'cluster' = capacities are clustered in groups
